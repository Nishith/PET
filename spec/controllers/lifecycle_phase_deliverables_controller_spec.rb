...
describe LifecyclePhaseDeliverablesController do
  ...
  describe "GET index" do
    it "assigns all lifecycle_phase_deliverables as @lifecycle_phase_deliverables" do
      ...
      get :index
      assigns(:lifecycle_phase_deliverables).should eq([lifecycle_phase_deliverable])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested lifecycle_phase_deliverable as @lifecycle_phase_deliverable" do
      lifecycle_phase_deliverable = LifecyclePhaseDeliverable.create! valid_attributes
      get :show, :id => lifecycle_phase_deliverable.id.to_s
      assigns(:lifecycle_phase_deliverable).should eq(lifecycle_phase_deliverable)
    end
  end

  describe "GET new" do
    it "assigns a new lifecycle_phase_deliverable as @lifecycle_phase_deliverable" do
      get :new
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created lifecycle_phase_deliverable as @lifecycle_phase_deliverable" do
        post :create, :lifecycle_phase_deliverable => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lifecycle_phase_deliverable" do
        ...
        LifecyclePhaseDeliverable.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => lifecycle_phase_deliverable.id, :lifecycle_phase_deliverable => {'these' => 'params'}
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested lifecycle_phase_deliverable" do
      lifecycle_phase_deliverable = LifecyclePhaseDeliverable.create! valid_attributes
      expect {
