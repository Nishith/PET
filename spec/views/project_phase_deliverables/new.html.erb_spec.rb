...
describe "project_phase_deliverables/new.html.erb" do
  before(:each) do
    assign(:new_project_phase_deliverable, Factory(:project_phase_deliverable))
  end
  ...
  it "renders new project_phase_deliverable form" do
    ...
    assert_select "form", :action => project_phase_deliverables_path, :method => "post" do
      ...
      assert_select "select#project_phase_deliverable_deliverable_type_id", :name => "project_phase_deliverable[deliverable_type_id]"
      assert_select "select#project_phase_deliverable_uom_id", :name => "project_phase_deliverable[uom_id]"
