...
describe "project_phase_deliverables/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit project_phase_deliverable form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => project_phase_deliverables_path(@project_phase_deliverable), :method => "post" do
      ...
      assert_select "select#edit_project_phase_deliverable_deliverable_type_id", :name => "project_phase_deliverable[deliverable_type_id]"
      assert_select "select#edit_project_phase_deliverable_uom_id", :name => "project_phase_deliverable[uom_id]"
      assert_select "select#edit_project_phase_deliverable_complexity", :name => "project_phase_deliverable[complexity]"
